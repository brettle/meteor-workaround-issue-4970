/* globals Accounts */
"use strict";
Tinytest.addAsync('brettle:workaround-issue-4970 - Workaround meteor bug #4970',
  function(test, done) {
    ...
    function onUser1LoggedIn(err) {
      ...
      test.isNotNull(Accounts.connection.onReconnect,
        'onReconnect is null after first user logged in');
      Accounts.callLoginMethod({
        methodArguments: [{
          bogusLoginService: "test2-" + Random.id()
        }],
